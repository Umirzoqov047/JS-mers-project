...
function form(modalTimer) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal_js__WEBPACK_IMPORTED_MODULE_0__.openModal)(".modal", modalTimer);
    ...
    setTimeout(() => {
      ...
      (0,_modal_js__WEBPACK_IMPORTED_MODULE_0__.closeModal)(".modal", modalTimer);
    }, 4000);
  }
}
